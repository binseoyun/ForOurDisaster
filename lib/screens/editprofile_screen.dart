...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserProfile() async {
    ...
    if (doc.exists) {
      ...
      final loadedCity = data['country'] ?? '서울';
      if (city.contains(loadedCity)) {
        _city = loadedCity;
      } else {
        _city = '서울'; // 목록에 없는 값이면 기본값으로 설정
      }
      setState(() {}); // 화면 반영
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              //DropdownButtonFormField는 사용자에게 국가 목록을 선택하게 함
              value: _city,
